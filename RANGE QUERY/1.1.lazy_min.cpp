...
//push function ensures that any pending updates 
//(stored in the lz field) are "pushed down" from the
// current node to its children, updating them as needed.
...
//he pull function is used to recalculate the current node's
// value (mn, the minimum value) based on its children after
// an update or modification
void pull(int id) {
